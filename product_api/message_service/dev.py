...
from .browser_settings import shipping, billing, card
import time

url = 'http://www.japanesenaturalstones.com/yoshiaki-fujiwara-2nd-kiridashi-damascus/'
...
# driver = webdriver.Firefox(executable_path='/Users/willshu/Projects/product_scanner/product_api/message_service/geckodriver', options=options)
driver.get(url)
...
time.sleep(1)
driver.save_screenshot('/Users/willshu/Projects/product_scanner/product_api/message_service/screenshot_before.png')
finish = driver.find_element_by_xpath('//*[@id="checkout-payment-continue"]')
#finish.click()
time.sleep(2)
driver.save_screenshot('/Users/willshu/Projects/product_scanner/product_api/message_service/screenshot_after.png')
time.sleep(10)
